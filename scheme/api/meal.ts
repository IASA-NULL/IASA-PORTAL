...
export function getMealTime(date = new Date()) {
    ...
    if (date.getHours() < 8 || (date.getHours() === 8 && date.getMinutes() <= 20)) type = 0
    else if (date.getHours() < 13 || (date.getHours() === 13 && date.getMinutes() <= 20)) type = 1
    else if (date.getHours() < 19 || (date.getHours() === 19 && date.getMinutes() <= 20)) type = 2
    else {
