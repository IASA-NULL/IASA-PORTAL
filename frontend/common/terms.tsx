        ...
        return (
            <div>
                ...
                <Typography use='body1'>
                    ...
                    NULL(이하 ‘NULL’)과 이를 이용하는 IASA Portal 서비스
                    회원(이하 ‘회원’)과의 관계를 설명하며, 아울러 여러분의
                ...
                <Typography use='body1'>
                    ...
                    제공하고 있습니다. 여러분은 PC, 태블릿 등 인터넷 이용이
                    가능한 각종 단말기를 통해 각양각색의 IASA Portal의 서비스를
                    자유롭게 이용하실 수 있으며, 개별 서비스들의 구체적인 내용은
                    각 서비스 상의 안내, 공지사항, NULL 또는 도움말 등에서 쉽게
                    확인하실 수 있습니다.
                </Typography>
                <br />
                <Typography use='body1'>
                ...
                <Typography use='body1'>
                    ...
                    부여합니다. 계정이란 회원이 서비스에 로그인한 이후 이용하는
                    각종 서비스 이용 이력을 회원 별로 관리하기 위해 설정한 회원
                    식별 단위를 말합니다.
                </Typography>
                <br />
                <Typography use='body1'>
                ...
                <Typography use='body1'>
                    ...
                    목적으로 서비스 상에 게재한 부호, 문자, 음성, 음향, 그림,
                    사진, 동영상, 링크 등으로 구성된 각종 콘텐츠 자체 또는
                    파일을 말합니다.
                </Typography>
                <br />
                <Typography use='body1'>
                ...
                <Typography use='body1'>
                    ...
                    및 새로운 서비스 개발을 위한 연구, 웹 접근성 등 법률상 의무
                    준수, 외부 사이트에서의 검색, 수집 및 링크 허용을 위해서만
                    제한적으로 행사할 것입니다. 만약, 그 밖의 목적을 위해 부득이
                    여러분의 콘텐츠를 이용하고자 할 경우엔 사전에 여러분께
                ...
                <Typography use='body1'>
                    ...
                    및 회원에 대해 관련 개인정보를 안전하게 처리하기 위하여
                    기울이는 노력이나 기타 상세한 사항은 개인정보 처리방침에서
                    확인하실 수 있습니다.
                </Typography>
                <br />
                <Typography use='body1'>
                    ...
                    후 여러분의 정보를 파기하거나 분리 보관할 수 있으며, 만약
                    이로 인해 서비스 제공을 위해 필수적인 정보가 부족해질 경우
                    부득이 관련 서비스 이용계약을 해지할 수 있습니다.
                </Typography>
                <br />
                <br />
                ...
                <Typography use='body1'>
                    ...
                    정보보호 등에 관한 법률’ 및 ‘저작권법’ 등을 근거로 권리침해
                    주장자의 요청에 따른 게시물 게시중단, 원 게시자의 이의신청에
                    따른 해당 게시물 게시 재개 등을 내용으로 하는
                    게시중단요청서비스를 운영하고 있습니다. 보다 상세한 내용 및
                ...
                <Typography use='body1'>
                    ...
                    위해서는 그 이용이 저작권법 등 관련 법률에 따라 허용되는
                    범위 내에 있거나, 해당 콘텐츠의 지식재산권자로부터 별도의
                ...
                <Typography use='body1'>
                    ...
                    여러분의 자유로운 이용은 IASA Portal이 제시하는 이용 조건에
                    부합하는 범위 내에서만 허용되고, 이러한 권한은 양도가
                    불가능하며, 비독점적 조건 및 법적고지가 적용된다는 점을
                    유의해 주세요.
                </Typography>
                <br />
                <br />
                ...
                <Typography use='body1'>
                    ...
                    Portal 서비스에서 여러분과 타인의 권리가 서로 존중되고
                    보호받으려면 여러분의 도움과 협조가 필요합니다. 여러분의
                    안전한 서비스 이용과 권리 보호를 위해 부득이 아래와 같은
                    경우 여러분의 게시물 게재나 IASA Portal 서비스 이용이 제한될
                    수 있으므로, 이에 대한 확인 및 준수를 요청 드립니다.
                </Typography>
                <br />
                <ul>
                    <li>
                        회원 가입 시 학번, 이름 등의 정보를 허위로 기재해서는 안
                        됩니다. 회원 계정에 등록된 정보는 항상 정확한 최신
                        정보가 유지될 수 있도록 관리해 주세요. 자신의 계정을
                        다른 사람에게 판매, 양도, 대여 또는 담보로 제공하거나
                        다른 사람에게 그 사용을 허락해서는 안 됩니다. 아울러
                        자신의 계정이 아닌 타인의 계정을 무단으로 사용해서는 안
                        됩니다. 이에 관한 상세한 내용은 계정 운영정책을 참고해
                        주시기 바랍니다.
                    </li>
                    <li>
                        타인에 대해 직접적이고 명백한 신체적 위협을 가하는
                        내용의 게시물, 타인의 자해 행위 또는 자살을 부추기거나
                        권장하는 내용의 게시물, 타인의 신상정보, 사생활 등
                        비공개 개인정보를 드러내는 내용의 게시물, 타인을
                        지속적으로 따돌리거나 괴롭히는 내용의 게시물, 성매매를
                        제안, 알선, 유인 또는 강요하는 내용의 게시물, 공공
                        안전에 대해 직접적이고 심각한 위협을 가하는 내용의
                        게시물은 제한될 수 있습니다.
                    </li>
                    <li>
                        관련 법령상 금지되거나 형사처벌의 대상이 되는 행위를
                        수행하거나 이를 교사 또는 방조하는 등의 범죄 관련
                        직접적인 위험이 확인된 게시물, 관련 법령에서 홍보, 광고,
                        판매 등을 금지하고 있는 물건 또는 서비스를 홍보, 광고,
                        판매하는 내용의 게시물, 타인의 지식재산권 등을
                        침해하거나 모욕, 사생활 침해 또는 명예훼손 등 타인의
                        권리를 침해하는 내용이 확인된 게시물은 제한될 수
                        있습니다.
                    </li>
                    <li>
                        ...
                        있는 폭력적이고 자극적인 내용의 게시물, 본인 이외의 자를
                        사칭하거나 허위사실을 주장하는 등 타인을 기만하는 내용의
                        게시물, 과도한 욕설, 비속어 등을 계속하여 반복적으로
                        사용하여 심한 혐오감 또는 불쾌감을 일으키는 내용의
                        게시물은 제한될 수 있습니다.
                    </li>
                    <li>
                        자동화된 수단을 활용하는 등 IASA Portal 서비스의 기능을
                        비정상적으로 이용하여 게재된 게시물, IASA Portal 각 개별
                        서비스의 제공 취지와 부합하지 않는 내용의 게시물은 다른
                        이용자들의 정상적인 IASA Portal 서비스 이용에 불편을
                        초래하고 더 나아가 IASA Portal의 원활한 서비스 제공을
                        방해하므로 역시 제한될 수 있습니다. 기타 제한되는
                        게시물에 관한 상세한 내용은 게시물 운영정책 및 각 개별
                        서비스에서의 약관, 운영정책 등을 참고해 주시기 바랍니다.
                    </li>
                    <li>
                        IASA Portal의 사전 허락 없이 자동화된 수단(예: 매크로
                        프로그램, 로봇(봇), 크롤러 등)을 이용하여 IASA Portal
                        서비스 회원으로 가입을 시도 또는 가입하거나, IASA Portal
                        서비스에 로그인을 시도 또는 로그인하거나, IASA Portal
                        서비스 상에 게시물을 게재하거나, IASA Portal 서비스를
                        통해 커뮤니케이션하거나(예: 전자메일, 쪽지 등), IASA
                        Portal 서비스에 게재된 회원의 아이디(ID), 게시물 등을
                        수집하는 등 이용자(사람)의 실제 이용을 전제로 하는 IASA
                        Portal 서비스의 제공 취지에 부합하지 않는 방식으로 IASA
                        Portal 서비스를 이용하거나 이와 같은 IASA Portal
                        서비스에 대한 어뷰징(남용) 행위를 막기 위한 IASA
                        Portal의 기술적 조치를 무력화하려는 일체의 행위(예: IP를
                        지속적으로 바꿔가며 접속하는 행위, Captcha를 외부 솔루션
                        등을 통해 우회하거나 무력화 하는 행위 등)를 시도해서는
                        안 됩니다.
                    </li>
                </ul>
                <Typography use='body1'>
                    ...
                    원활한 서비스 이용이 가능하도록 지원하고 있습니다. 각 세부
                    정책에는 여러분이 참고할 수 있도록 보다 구체적인 유의사항을
                    포함하고 있으니, 본 약관 본문 및 구성 페이지 상의 링크 등을
                    통해 이를 확인해 주시기 바랍니다.
                </Typography>
                <br />
                <br />
                ...
                <Typography use='body1'>
                    ...
                    약관, 운영정책 등에 위배되는 경우, 부득이 이를 비공개 또는
                    삭제 처리하거나 게재를 거부할 수 있습니다. 다만, 이것이 IASA
                    Portal가 모든 콘텐츠를 검토할 의무가 있다는 것을 의미하지는
                    않습니다.
                </Typography>
                <br />
                <Typography use='body1'>
                    ...
                    확인 결과에 따라 IASA Portal 서비스 이용에 대한 주의를
                    당부하거나, IASA Portal 서비스 이용을 일부 또는 전부, 일시
                    또는 영구히 정지시키는 등 그 이용을 제한할 수 있습니다.
                    한편, 이러한 이용 제한에도 불구하고 더 이상 IASA Portal
                    서비스 이용계약의 온전한 유지를 기대하기 어려운 경우엔
                ...
                <Typography use='body1'>
                    ...
                    포인트 및 기타 혜택 등은 모두 소멸되고 이에 대해 별도로
                    보상하지 않으므로 유의해 주시기 바랍니다. 서비스 이용 제한의
                    조건, 세부 내용 등은 계정 운영정책 및 각 개별 서비스에서의
                    운영정책을 참고하시기 바랍니다.
                </Typography>
                <br />
                <br />
                ...
                <Typography use='body1'>
                    ...
                    또는 이에 준하는 불가항력으로 인하여 IASA Portal이 서비스를
                    제공할 수 없거나 이용자의 고의 또는 과실로 인하여 서비스를
                    이용할 수 없어 발생한 손해에 대해서 IASA Portal은 책임을
                    부담하지 않습니다.
                </Typography>
                <br />
                <Typography use='body1'>
                ...
                <Typography use='body1'>
                    ...
                    콘텐츠를 신뢰함으로써 발생한 손해에 대해서도 IASA Portal은
                ...
                <Typography use='body1'>
                    ...
                    상당한 이유가 있는 경우 부득이 서비스의 전부 또는 일부를
                    중단할 수 있습니다.
                </Typography>
                <br />
                <Typography use='body1'>
                    ...
                    일부를 수정, 변경 또는 종료하게 된 경우 관련 법령에 특별한
                ...
                <Typography use='body1'>
                    ...
                    여러분 자신의 콘텐츠를 백업할 수 있도록 합리적이고 충분한
                    기회를 제공하도록 하겠습니다.
                </Typography>
                <br />
                <br />
                ...
                <Typography use='body1'>
                    ...
                    통해 개별적으로 알려 드릴 것이며, 다만 회원 전체에 대한
                    통지가 필요할 경우엔 7일 이상 www.iasa.kr 을 비롯한 IASA
                    Portal 도메인의 웹사이트 및 응용프로그램(어플리케이션, 앱)
                    초기 화면 또는 공지사항 등에 관련 내용을 게시하도록
                    하겠습니다.
                </Typography>
                <br />
                <Typography use='body1'>
                    ...
                    범위 내에서 가능한 그 처리과정 및 결과를 여러분께 전달할 수
                    있도록 하겠습니다.
                </Typography>
                <br />
                <br />
                ...
                <Typography use='body1'>
                    ...
                    알리도록 하겠습니다. 또한 여러분에게 불리할 수 있는 중대한
                    내용의 약관 변경의 경우에는 최소 30일 이전에 해당 서비스 내
                    공지하고 별도의 전자적 수단(전자메일, 서비스 내 알림 등)을
                    통해 개별적으로 알릴 것입니다.
                </Typography>
                <br />
                <Typography use='body1'>
                    ...
                    않으면, 여러분이 변경된 약관에 따라 서비스를 이용하는 데에
                    동의하는 것으로 간주됩니다. IASA Portal으로서는 매우
                    안타까운 일이지만, 여러분이 변경된 약관에 동의하지 않는 경우
                ...
                <Typography use='body1'>
                    ...
                    따라서 별도의 약관, 운영정책에서 그 개별 서비스 제공에
                    관하여 본 약관, 계정 및 게시물 운영정책과 다르게 정한
                    경우에는 별도의 약관, 운영정책이 우선하여 적용됩니다. 이러한
                    내용은 각각의 개별 서비스 초기 화면에서 확인해 주시기
                    바랍니다.
                </Typography>
                <br />
                <Typography use='body1'>
                    ...
                    관련하여 여러분과 IASA Portal 사이에 분쟁이 발생할 경우, 그
                    분쟁의 처리는 대한민국 '민사소송법'에서 정한 절차를
                    따릅니다.
                </Typography>
                <br />
                <ul>
