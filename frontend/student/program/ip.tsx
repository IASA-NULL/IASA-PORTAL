...
export function Program_Ip() {
    return <>
        ...
        <BrIfMobile/>
        <Typography use="subtitle1" style={{marginLeft: '10px'}}>아주 간편한 IP 변경 프로그램</Typography>
        <br/>
        <br/>
        <Typography use="headline5">다운로드</Typography>
        <BrIfMobile/>
        <Typography use="subtitle2" style={{marginLeft: '10px'}}>V 4.2.1</Typography>
        <br/>
        <br/>
        ...
        <p>이제 프로그램이 컴퓨터를 킬 때 관리자 권한으로 자동으로 실행돼요.</p>
        <br/>
