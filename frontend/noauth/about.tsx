    ...
    return <>
        ...
        <div style={{
            ...
            <div style={{textAlign: 'center', color: 'white'}}>
                <Typography use="headline1">IASA PORTAL</Typography>
                <br/>
                <br/>
                <Typography use="headline3">인천과학예술영재학교 통합 학사포털</Typography>
                <br/>
                <br/>
                <br/>
            ...
            <div style={{textAlign: 'center', alignSelf: 'flex-end'}}>
                <footer style={{width: '100vw', textAlign: 'center', color: 'white'}}>
                    <br/>
                    <br/>
